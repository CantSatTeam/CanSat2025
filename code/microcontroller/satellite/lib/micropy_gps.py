...
if __name__ == "__main__":
    ...
    while True:
        ...
        lat = gps.latitude  # Get latitude
        lon = gps.longitude  # Get longitude
        print(f"Latitude: {lat}, Longitude: {lon}")
        
        # Access speed in knots
        speed_knots = gps.speed[0]  # List: [speed, decimal places]
        speed_kmh = speed_knots * 1.852  # Convert to km/h
        speed_mps = speed_knots * 0.514444  # Convert to m/s

        print(f"Speed: {speed_knots:.2f} knots | {speed_kmh:.2f} km/h | {speed_mps:.2f} m/s")
